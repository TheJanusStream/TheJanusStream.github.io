...
export const APP_NAMES = ['lsystem-explorer', 'symbios-ground-lab', 'symbios-robot-lab'] as const;

/** Bevy-layer crate names */
export const BEVY_NAMES = ['bevy_symbios', 'bevy_symbios_texture', 'bevy_symbios_ground', 'bevy_symbios_shape'] as const;
