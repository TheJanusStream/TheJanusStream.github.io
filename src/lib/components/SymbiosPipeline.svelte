            ...
            <div class="flex flex-col-reverse gap-6 relative z-10">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        {#each ['symbios', 'symbios-texture', 'symbios-shape', 'symbios-neat', 'symbios-tensor', 'symbios-audio', 'symbios-avatar', 'symbios-robot', 'symbios-genetics', 'symbios-ground', 'symbios-turtle-3d'] as crate (crate)}
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {#each ['bevy_symbios_shape', 'bevy_symbios_multiuser', 'bevy_symbios', 'bevy_symbios_ground', 'bevy_symbios_texture', 'bevy_symbios_audio', 'bevy_symbios_avatar'] as crate (crate)}
                            {@const c = getCrate(crate)}
                            <div bind:this={cardEls[crate]}
