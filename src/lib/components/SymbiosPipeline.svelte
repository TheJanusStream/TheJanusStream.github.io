            ...
            <div class="flex flex-col-reverse gap-6 relative z-10">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        {#each ['symbios', 'symbios-avatar', 'symbios-shape', 'symbios-neat', 'symbios-tensor', 'symbios-audio', 'symbios-texture', 'symbios-robot', 'symbios-genetics', 'symbios-ground', 'symbios-turtle-3d'] as crate (crate)}
